...
// =============================================
// بيانات المستخدم الحالي (مؤقتة)
// =============================================
$current_user = [
    'id' => 1,
    'name' => 'أحمد الفحص',
    'username' => 'ahmed.pentest',
    'email' => 'a.pentest@company.com',
    'role' => 'pentester',
    'level' => 'متقدم',
    'department' => 'وحدة اختبار الاختراق',
    'avatar' => null,
...
function hasPermission($required_role) {
    global $current_user;
    $roles = ['viewer' => 1, 'analyst' => 2, 'manager' => 3, 'admin' => 4];
    return $roles[$current_user['role']] >= $roles[$required_role];
}
?>
<?php
/**
 * auth.php
 * نظام التحقق من المستخدمين والصلاحيات
 */
...
class Auth {
    ...
    private function getUserDashboard($role) {
        $dashboards = [
            ...
            'technical_writer' => '/writer/dashboard.php',
            'reviewer' => '/reviewer/dashboard.php',
            'viewer' => '/viewer/dashboard.php'
        ];
